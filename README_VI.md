...
**Lưu ý:** Vốn cơ sở chỉ dùng cho scale (lot, TP, SL, trailing). Thông báo "Change vs initial capital at EA startup" dùng **vốn lúc EA attach** (hoặc đầu phiên), không dùng vốn cơ sở.
...
- **Change vs initial capital at EA startup** – % tính theo **vốn lúc EA attach** (hoặc đầu phiên), không tính theo vốn cơ sở. Vốn cơ sở vẫn dùng cho scale lot/TP/SL/Trailing.
...
2.04 – Advanced Grid Trading EA (Pro). AA, BB, CC; Buy Stop trên đường gốc và trên giá, Sell Stop dưới đường gốc và dưới giá; mỗi bậc tối đa 1 lệnh mỗi loại; pool chung; cân bằng thống nhất (xa nhất trước, cùng bậc: AA → BB → CC, đóng một phần nếu pool không đủ); gồng lãi; thông báo Telegram.
